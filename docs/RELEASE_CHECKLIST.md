...
Last reviewed: 2026-07-05 for template `4.5.2` local validation. Remote GitHub Actions runner parity is still required before release tagging.
...
- [ ] Progressive JPEG delivery, implementation gates, final-plan object readiness, 1% production-function behavior, and plan/inventory/depth verification order are present in shared rules, AGENTS/CLAUDE, Codex planning/feature/design skills, writing rules, and production-standard validator checks
