...
by their explicit fixtures. Mature downstream repositories can therefore keep
real `specs/*/spec.md` artifacts without receiving false strategic-review test
failures.
