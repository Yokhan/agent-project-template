...
Last reviewed: 2026-06-19 for template `4.3.0`; product/business outcome priority, text policy, platform policy, CI runtime hygiene, production design QA, and register-aware design pipeline checks are enforced by validators.
