...
Last reviewed: 2026-06-19 for template `4.3.1`; product/business outcome priority, text policy, platform policy, CI runtime hygiene, production design QA, register-aware design pipeline checks, and release-facing documentation count checks are enforced by validators.
